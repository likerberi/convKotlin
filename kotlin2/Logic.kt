...
class BallCompare {
    fun ballCompareResult(answerBallList: List<Ball>, userBallList: List<Ball>): BallStatusResult {
        ...
        return BallStatusResult(strike, ball)
    }
    ...
    companion object {
        fun compareBall(answerBall: Ball, userBall: Ball): BallStatus {
            ...
            return if (answerBall.ball == userBall.ball) {
                BallStatus.BALL
            } else BallStatus.NOTHING
        }
